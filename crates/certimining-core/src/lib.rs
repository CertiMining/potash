...
//!
//! E-01 provides the error space (§2.1), the digest types (§2.2) and the Keccak-256 hashers
//! (§1.1). The crate is `no_std` and has no Solana dependency outside the `solana` feature (§2).
